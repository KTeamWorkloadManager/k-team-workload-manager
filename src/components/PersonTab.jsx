...
export default function PersonTab({
  ...
  projects, onCompleteTask, onCreateProjectForPerson,
}) {
        ...
        <div style={cardStyle()}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: 8, marginBottom: 14 }}>
            ...
            {onCreateProjectForPerson && (
              <button onClick={() => onCreateProjectForPerson(selectedPerson.id)} style={{ ...actionBtn, fontSize: 12, padding: "5px 10px" }}>
                + New
              </button>
            )}
          </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(7, 1fr)", gap: 6 }}>
            ...
            {personMonthGrid.map((date) => {
              ...
              const dueTasks = projectTasks
                .filter((t) => t.assigned_to === selectedPerson.id && t.due_date === dateKey && t.status !== "Complete")
                .sort((a, b) => a.title.localeCompare(b.title));
